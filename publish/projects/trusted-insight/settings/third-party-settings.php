			...
			<div class="eight columns middle">
				<div id="settings">
						<div class="form-section">	
							<h1>Third Party Settings</h1>
							<hr>
							<div class="third-party-connection">
								<h2>Connect with Facebook</h2>
								<p>A blurb about why you should use this feature</p>
								<button class="social-connect facebook">
								 <span><p>Connect with Facebook</p></span>
								</button>
							</div>
							<div class="third-party-connection">
								<h2>Connect with Twitter</h2>
								<p>A blurb about why you should use this feature</p>
								<button class="social-connect twitter">
								 <span><p>Connect with Twitter</p></span>
								</button>
							</div>
							<div class="third-party-connection">
								<h2>Connect with LinkedIn</h2>
								<p>A blurb about why you should use this feature</p>
								<button class="social-connect linkedin">
								 <span><p>Connect with LinkedIn</p></span>
								</button>
							</div>
			...
			<div class="four columns right">
				<section id="settings-nav">	
					...
					<ul>
						...
						<li class="current"><a href="../settings/third-party-settings.php"><img src="../images/facebook-icon.png" alt="privacy" />Third Party Settings</a></li>
					</ul>
				</section>
			</div>
