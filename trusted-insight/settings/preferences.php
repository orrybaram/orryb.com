				...
				<div id="settings">
						<div class="form-section">	
							...
							<form>
								...
								<label class="checkbox-label">Email me when I recieve an invitation.</label>
								<input class="checkbox" type=checkbox /> 
								<label class="checkbox-label">Email me a receipt when I send an invitation.</label>
								<input class="checkbox" type=checkbox /> 
								<label class="checkbox-label">Email me when an invitation is accepted.</label>
								<input class="checkbox" type=checkbox /> 
								<label class="checkbox-label">Email me when I receive a message.</label>
			...
			<div class="four columns right">
				<section id="settings-nav">	
					...
					<ul>
						...
						<li class="current"><a href="../settings/preferences.php"><img src="../images/cog-preferences-icon.png" alt="preferences" />Preferences</a></li>
